...
const { pending, data } = await useCustomFetch<ShopInfoVo[]>('/admin/handOrder/v2/shop', {
  method: 'GET',
  headers: {
    'Content-Type': 'application/json'
  }
})
shopList.value = data.value?.filter(shop => shop.qrStoreCode !== null)
